...
def audio_state(kind: str, audio: dict | None = None) -> tuple[str, dict]:
    ...
    if kind == "microphone":
        ...
        attributes = {
            ...
            "voice_runtime": audio.get("voice_runtime", "unavailable"),
            "continuous_conversation": bool(audio.get("continuous_conversation")),
            "interrupt_word": audio.get("interrupt_word"),
